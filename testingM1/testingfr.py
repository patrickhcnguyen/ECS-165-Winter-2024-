...
record7 = [47, 2, 3, 5, 6]
record8 = [47, 3, 4, 6, 9]
record11 = [47, 4, 5, 6, 10]
record12 = [47, 5, 10, 15, 20]
...
print(t1.select_record_version(47, 1, [1,1,1,1,1], 0)[0].columns)
t1.merge()
print(t1.select_record_version(47, 1, [1,1,1,1,1], 0)[0].columns)

t1.update_record(47, *record11)
t1.update_record(47, *record12)
print(t1.select_record_version(47, 1, [1,1,1,1,1], 0)[0].columns)
# q = Query(t1)
